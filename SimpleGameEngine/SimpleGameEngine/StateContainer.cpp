...
CStateContainer::CStateContainer()
{
}

/*! Gives room specified id*/
CStateContainer::CStateContainer(std::string id)
{
	m_strID = id;
}
...
GAMESTATE CStateContainer::HandleInput(std::vector<CObject *> permObjects)
{
	SDL_Event event;
...
GAMESTATE CStateContainer::Update(std::vector<CObject *> permObjects)//pass in the game object objects so we can check for collisions etc
{
...
GAMESTATE CStateContainer::ProcessInput(std::vector<CObject *> permObjects)
{
	return STATE_RUNNING;
}

std::string CStateContainer::GetTransitionData()
{
